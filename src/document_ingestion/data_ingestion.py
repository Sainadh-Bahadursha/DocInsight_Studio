...
class FaissManager:
    ...
    def load_or_create(self,texts:Optional[List[str]]=None, metadatas: Optional[List[dict]] = None):
        ...
        if not texts:
            raise DocInsightStudioException("No existing FAISS index and no data to create one", sys)
...
class ChatIngestor:
    def __init__( self,
        ...
        try:
            ...
            raise DocInsightStudioException("Initialization error in ChatIngestor", e) from e
    ...
    def built_retriver( self,
        ...
        *,
        ...
        try:
            ...
            raise DocInsightStudioException("Failed to build retriever", e) from e
...
class DocHandler:
    ...
    def save_pdf(self, uploaded_file) -> str:
        try:
            ...
            raise DocInsightStudioException(f"Failed to save PDF: {str(e)}", e) from e
    ...
    def read_pdf(self, pdf_path: str) -> str:
        try:
            ...
            raise DocInsightStudioException(f"Could not process PDF: {pdf_path}", e) from e
class DocumentComparator:
    ...
    def save_uploaded_files(self, reference_file, actual_file):
        try:
            ...
            raise DocInsightStudioException("Error saving files", e) from e
    ...
    def combine_documents(self) -> str:
        try:
            ...
            raise DocInsightStudioException("Error combining documents", e) from e
    ...
    def clean_old_sessions(self, keep_latest: int = 3):
        try:
            ...
            raise DocInsightStudioException("Error cleaning old sessions", e) from e
